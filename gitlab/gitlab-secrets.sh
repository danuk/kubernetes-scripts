...
# Written by DaNuk (DNk) 2019 mail@danuk.ru
# Get all secrets from GitLab project
# Project name get automatically by directory name
# You can present Group name by first script argument

GITLAB_URL="https://gitlab.domain.ru"
GROUP=$1
